...
public class LrcTimedTextUtilsTest
{
    ...
    // Multiple empty tags
    [TestCase(
        "<00:51.00> <01:29.99><01:48.29>  <02:31.00> <02:41.99>You gotta fight !", 0,
        "You gotta fight !", new[] { "[0,start]:161990" }
    )]
    public void TestDecode(string text, int lineStartTime, string expectedText, string[] expectedTimeTags)
    {
